...
LOCAL_SERVER_HOST = 'olivaw-wifi.internal'
REMOTE_SERVER_HOST = 'turtle.cjv6.net'
BUFSIZE = 4096
...
class Sender(asyncore.dispatcher):
	...
	def handle_read(self):
		read = self.recv(BUFSIZE)
		buf = b''.join([
				self.receiver.to_remote_buffer,
				read
				])
		self.receiver.to_remote_buffer = buf
